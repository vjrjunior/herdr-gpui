...
- `orbita`: `comfortable-rounded` with a chevron to fold a repository, a yellow
  dot for uncommitted work, tree guides tying worktrees to their repository, each child's highlight starting where its guide's tick ends, the
